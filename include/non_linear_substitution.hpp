...
public:
    ...
    static inline uint8_t Forward(uint8_t input) { return nonlinear_substitution[input]; }
    ...
    static inline uint8_t Backward(uint8_t input) { return inverted_nonlinear_substitution[input]; }
};